...
// TODO: Add comprehensive unit tests for command dispatcher
// Infrastructure for coverage is in place via cargo-tarpaulin
// Tests can be added incrementally using simpler mock approaches
